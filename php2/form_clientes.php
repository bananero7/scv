...
<script src="../js/form_clientes.js"></script>
  ...
  <main>
    <div class="contenedor_registro">
        <form action= "guardar_clientes.php" method="post">
              <table id="registro">
              <tr>
              <th colspan="2"><h1>Registro Clientes</h1></th>
              </tr>
                <tr>
                  <th>Cedula: </th>
                  <td>
                      <input type="number" id="txtCedula" name="txtCedula"/>
                      <input type="button" id="btnConsulta" name="btnConsulta" value="validar" onClick="Validar()" />
                  </td>
                </tr>
                <tr>
                  <th>Nombre: </th>
              ...
              <table>
                <tr>
                  <th>
                    <input type="button" id="btnEnviar" name="btnEnviar" value="Guardar" onCLick="Guardar()"/>
                    <input type="button" id="btnActualizar" name="btnActualizar" value="Actualizar" onCLick="Actualizar()"/>
                    <input type="button" id="btnLimpiar" name="BtnLimpiar" value="Limpiar" onClick="Limpiar()" />
                  </th>
                </tr>
              </table>
          </div>
...
<div class="contenedor_tabla_datos">
  <table id="tabla_datos">
    <tr>
      <th colspan="10"><h1>Listado de Clientes </h1></th>
    </tr>
    <tr>
      <th>Id</th>
      <th>Cedula</th>
